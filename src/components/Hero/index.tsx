...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] h-[800px]"
        style={{
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[1200px] text-center">
                {/* Title */}
                <TextAnimator
                  sequence={["Accurate, Detailed, and Trusted Reports", 2000, "", 1000]}
                  className="text-white"
                />

                {/* Subheading */}
                <div className="mb-8 flex justify-center space-x-8 mt-5">
                  <span className="cursor-pointer text-lg text-white font-semibold text-body-color hover:text-white dark:text-body-color-dark">
                    All
                  </span>

                  <span className="cursor-pointer text-lg text-white font-semibold text-body-color dark:text-body-color-dark">
                    New
                  </span>
                  <span className="cursor-pointer text-lg text-white font-semibold text-body-color dark:text-body-color-dark">
                    Used
