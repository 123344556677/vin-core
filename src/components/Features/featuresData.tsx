...
const featuresData: Feature[] = [
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        ...
        <path
          d="M20 12a2 2 0 110 4 2 2 0 010-4zm-1 8h2v10h-2V20z"
          fill="currentColor"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        ...
        <circle cx="26" cy="14" r="6" fill="currentColor" opacity="0.5" />
        <path
          d="M5 28c0-4.418 3.582-8 8-8h14c4.418 0 8 3.582 8 8v5H5v-5z"
          fill="currentColor"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <rect x="5" y="10" width="30" height="20" rx="3" ry="3" fill="currentColor" opacity="0.5" />
        <circle cx="20" cy="20" r="6" fill="currentColor" />
        <path
          d="M18 19h4v2h-4zM17 22h6v2h-6z"
          fill="white"
        />
      </svg>
