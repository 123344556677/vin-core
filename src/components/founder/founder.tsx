...
<div className="flex flex-col md:flex-row items-start gap-8">
  ...
  <div className="relative -mt-32 md:-mt-40 md:w-1/2 lg:w-2/5">
    <div className="relative group">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-200/30 to-purple-300/20 
      ...
      {/* Reflective Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/10 to-white/5 
